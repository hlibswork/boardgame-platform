...
urlpatterns = [
    ...
    path("boardgames/update/<int:pk>", BoardGameUpdateView.as_view(), name="board-game-update"),
    path("boardgames/delete/<int:pk>", BoardGameDeleteView.as_view(), name="board-game-delete"),
